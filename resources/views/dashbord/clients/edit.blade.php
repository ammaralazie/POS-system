...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="{{ route('dashbord.clients.update', ['id' => $client->id]) }}" method="post">
                {{ csrf_field() }}
                @method('put')
                ...
                @for ($i = 0; $i < count($client->phone); $i++)
                    <div class="form-group">
                        ...
                        <input type="text" name="phone[]" id="" class="form-control" value="{{ $client->phone[$i] }}">
                    </div>
                @endfor

                <div class="form-group">
                    <label for="">@lang('site.adress')</label>
                    <input type="text" name="address" id="" class="form-control" value="{{ $client->name }}">
                </div>
